{!! Form::open(['route' => ['finance.update', $note->id], 'method' => 'post']) !!}
@csrf
@method('patch')

{{ Form::label('type', 'Choose Type', ['class' => 'control-label']) }}
{{ Form::select('type', ['income' => 'Income', 'costs' => 'Costs'], null, ['class' => 'form-control form-control-lg', 'disabled'])  }}
...
<div class="row justify-content-center mt-3">
    <div class="col-sm-6">
        <button class="btn btn-block btn-success" type="submit">Update Income Note</button>
    </div>
</div>
